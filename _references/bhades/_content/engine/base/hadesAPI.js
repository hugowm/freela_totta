...
hAPI.prototype.createInterface = function(){
    ...
    this.m.drawRect(0, 60, CONFIG.screen.width, CONFIG.screen.height - 60 - 40);
    this.m.endFill();
    ...
    this.title = new PIXI.Text(DATA_CURSO.nome_curso, {font: '800 20px Calibri', fill: '#00779d'});
    this.title_tela = new PIXI.Text(this.menu.bts[currentPage].t.replace('- ', ''), {font: '20px Calibri', fill: '#00779d'});
}
...
hAPI.prototype.draw = function(){
    this.title.x = 225;
    this.title.y = 10;
    this.title_tela.x = 225;
    this.title_tela.y = 30;
    this.lineTopo.x = 205;
